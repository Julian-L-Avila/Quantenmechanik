...
\pgfplotstableread[col sep=comma, header=true]{
  config, f1, f2, f3
  1-5, 1.1669, 0.8305, 1.2647
  1-6, 1.1669, 0.8343, 1.3120
  2-6, 1.1815, 0.8366, 1.3120
  4-6, 1.2394, 0.8437, 1.3122
  6-6, 1.3100, 0.8513, 1.3356
}\theoric

\pgfplotstableread[col sep=comma, header=true]{
  config, fe, ft, err
  \multirow{3}{*}{1-5}, 0.8308, 0.8305, 0.0361
  , 1.1934, 1.1669, 2.2205
  , 1.2771, 1.2647, 0.9709
  \multirow{3}{*}{1-6}, 0.8415, 0.8343, 0.8556
  , 1.1901, 1.1669, 1.9494
  , 1.3144, 1.3120, 0.1826
  \multirow{3}{*}{2-6}, 0.8378, 0.8366, 0.1432
  , 1.2114, 1.1815, 2.4682
  , 1.3189, 1.3120, 0.5232
  \multirow{3}{*}{4-6}, 0.8498, 0.8437, 0.7178
