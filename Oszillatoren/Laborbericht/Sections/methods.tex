...
\begin{figure}[htbp!]
  \centering
  \subfloat[Configuraci\'on 5-1\label{fig:conf-1-5}]{
    \scalebox{-1}[1]{\includegraphics[width=0.3\textwidth]{./Figures/15.pdf}}
  }
  \hfill
  \subfloat[Configuraci\'on 6-1\label{fig:conf-1-6}]{
    \scalebox{-1}[1]{\includegraphics[width=0.3\textwidth]{./Figures/16.pdf}}
  }
  \hfill
  \subfloat[Configuraci\'on 6-2\label{fig:conf-2-6}]{
    \scalebox{-1}[1]{\includegraphics[width=0.3\textwidth]{./Figures/26.pdf}}
  }

  \vspace{0.5cm}

  \subfloat[Configuraci\'on 6-4\label{fig:conf-4-6}]{
    \scalebox{-1}[1]{\includegraphics[width=0.3\textwidth]{./Figures/46.pdf}}
  }
  \hspace{0.1\textwidth}
  \subfloat[Configuraci\'on 6-6\label{fig:conf-6-6}]{
    \scalebox{-1}[1]{\includegraphics[width=0.3\textwidth]{./Figures/66.pdf}}
  }
