...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{Figures/barras_metalicas.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/constante_elastica.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/montaje_completo.jpg}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{Figures/configuraciones_resortes.jpg}
